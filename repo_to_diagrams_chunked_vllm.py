...
DIAGRAM_SYNTAX_HINTS: Dict[str, str] = {
    "activity": (
        ...
        "\\n"
        "CRITICAL — fork/fork again/end fork are ALL at the SAME indent level. NEVER nest fork inside fork:\\n"
        "  WRONG (nested — PlantUML cannot find fork):\\n"
        "    fork\\n"
        "      fork again\\n"
        "        :Branch A;\\n"
        "      end fork\\n"
        "    end fork\\n"
        "  CORRECT (flat — fork again separates branches at same level):\\n"
        "    fork\\n"
        "      :Branch A;\\n"
        "    fork again\\n"
        "      :Branch B;\\n"
        ...
        "      :Branch C;\\n"
        "    end fork\\n"
        "To model parallel groups of actions, put all actions in one branch per 'fork again' — do NOT use nested forks.\\n"
        "\n"
        "repeat/repeat while:\n"
        "  repeat\n"
        "    :action;\n"
